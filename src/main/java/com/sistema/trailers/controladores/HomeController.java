...
public class HomeController {
	...
	public ModelAndView verPaginaDeInicio() {
		List<Pelicula> utimasPeliculas = peliculaRepositorio.findAll(PageRequest.of(0, 4,Sort.by("fechaEstreno").descending())).toList();
		
		return new ModelAndView("index").addObject("ultimasPeliculas",utimasPeliculas);
	}
